        ...
        <div class="grid grid-cols-1 gap-6 mt-10 sm:grid-cols-2">
            ...
            <div>
                <label for="dropzone-file" class="flex items-center px-3 py-2  mx-auto mt-8 text-center bg-white border  rounded-lg cursor-pointer dark:border-gray-600 ">
                    ...
                    <h2 class="mx-3 text-gray-600">Compétances Photo</h2>
    
                    <input id="dropzone-file" name="domain_photo" type="file" class="hidden" />
                </label>           
             </div>
        </div>

        <div class="flex justify-end mt-6">
            <button type="submit" class="px-8 py-2.5 leading-5 text-white transition-colors duration-300 transform bg-blue-500 rounded-md hover:bg-blue-700 focus:outline-none focus:bg-gray-600">Save</button>
        </div>
    </form>
</section>
