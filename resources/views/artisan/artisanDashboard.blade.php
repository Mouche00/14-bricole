...
<div class="container flex flex-col px-6 py-10 mx-auto space-y-6 lg:h-[32rem] lg:py-16 lg:flex-row lg:items-center">
    <div class="w-full lg:w-1/2">
        <div class="lg:max-w-lg">
            ...
            <p class="mt-4 text-gray-800">We work with the best remunated glasses dealers in US to find your new glasses.</p>
            <div class="grid gap-6 mt-8 sm:grid-cols-2">
                <div class="flex items-center text-gray-800 -px-3 dark:text-gray-800">
                    <svg class="w-5 h-5 mx-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                    </svg>

                    <span class="mx-3 text-gray-600">Premium selection</span>
                </div>
                ...
                <div class="flex items-center text-gray-800 -px-3 dark:text-gray-800">
                    ...
                    <span class="mx-3 text-gray-600">All legal documents</span>
                </div>
                ...
                <div class="flex items-center text-gray-800 -px-3 dark:text-gray-800">
                    ...
                    <span class="mx-3 text-gray-600">From US glasses dealers</span>
                </div>
                ...
                <div class="flex items-center text-gray-800 -px-3 dark:text-gray-800">
                    ...
                    <span class="mx-3 text-gray-600">Payment Security</span>
                </div>
                ...
                <div class="flex items-center text-gray-800 -px-3 dark:text-gray-800">
                    ...
                    <span class="mx-3 text-gray-600">Fast shipping (+ Express)</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="flex items-center justify-center w-full h-96 lg:w-1/2">
        <img class="object-cover w-full h-full max-w-2xl rounded-md" src="{{url('img/image.jpg')}}" alt="glasses photo">
    </div>
</div>
...
<div class="relative bg-gray-50 pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8">
    <div class="absolute inset-0 bg-gray-100">
      <div class="bg-gray-100 h-1/3 sm:h-2/3"></div>
    </div>
