...
<section class="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md mt-32">
    ...
    <form>
        <div class="grid grid-cols-1 gap-6 mt-10 sm:grid-cols-2">
            <div>
                <label class="text-gray-600" for="domain">Domain</label>
                <input id="domain" type="text" name="Domain" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-blue-400 rounded-md  dark:text-gray-600 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
            </div>

            <div>
                <label class="text-gray-600" for="description">Description</label>
                <input id="description" name="description" type="email" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-blue-400 rounded-md  dark:text-gray-600 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
            </div>
            ...
            <div class="flex flex-col">
                ...
                <div class="dropdown">
                    ...
                    <div id="dropdownContent" class="dropdown-content">
                        <label>
                            <input type="checkbox" name="competances" value="1" class="mr-2" onchange="updateSelection(this)"> Option 1
                        </label>
                        <label>
                            <input type="checkbox" name="competances" value="2" class="mr-2" onchange="updateSelection(this)"> Option 2
                        </label>
                        <label>
                            <input type="checkbox" name="competances" value="3" class="mr-2" onchange="updateSelection(this)"> Option 3
                        </label>
                        <label>
                            <input type="checkbox" name="competances" value="4" class="mr-2" onchange="updateSelection(this)"> Option 4
                        </label>
                        <label>
                            <input type="checkbox" name="competances" value="5" class="mr-2" onchange="updateSelection(this)"> Option 5
                        </label>
                    </div>
                </div>
            ...
            <div>
                <label for="dropzone-file" class="flex items-center px-3 py-2  mx-auto mt-8 text-center bg-white border  rounded-lg cursor-pointer dark:border-gray-600 ">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-gray-600 dark:text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" />
                    </svg>
    
                    <h2 class="mx-3 text-gray-600">Domain Photo</h2>
        ...
        <div class="flex justify-end mt-6">
            <button class="px-8 py-2.5 leading-5 text-white transition-colors duration-300 transform bg-blue-500 rounded-md hover:bg-blue-700 focus:outline-none focus:bg-gray-600">Save</button>
        </div>
    </form>
</section>
