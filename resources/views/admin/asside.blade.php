<aside class="flex flex-col w-64 h-screen px-4 py-4 overflow-y-auto bg-white   shadow-lg dark:border-gray-700">
    ...
    <div class="flex flex-col items-center mt-6 -mx-2">
        <img class="object-cover w-24 h-24 mx-2 rounded-full" src="{{ asset('images/users/' . $user->picture) }}" alt="avatar">
    ...
    <div class="flex flex-col justify-between flex-1 mt-6">
        <nav>
            ...
            <a href="{{route('logout')}}" class="flex items-center gap  px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-red-600 dark:hover:text-gray-200 hover:text-gray-700" href="#">
