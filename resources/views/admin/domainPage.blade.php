...
<div class="container flex gap-10">
    <aside class="flex flex-col w-64 h-screen px-4 py-4 overflow-y-auto bg-white   shadow-lg dark:border-gray-700">
        ...
        <div class="flex flex-col justify-between flex-1 mt-6">
            <nav>
                <a href="{{route('admin')}}" class="flex items-center px-4 py-2 text-gray-700 rounded-lg dark:text-gray-400 hover:text-white dark:hover:bg-blue-600 duration-300" href="#">
