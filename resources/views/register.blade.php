    ...
    <div class="flex justify-center min-h-screen">
        <div class="hidden bg-cover lg:block lg:w-2/5" style="background-image: url('img/register.jpg')">
            <div class="bg-gray-900 bg-opacity-40">
                <a href="login"><button class=" absolute ml-5 mt-5 hover:bg-blue-500 duration-700 bg-gray-200 rounded-lg px-1">
                    <svg class="w-[46px] h-[36px] text-blue-400 hover:text-white duration-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        ...
        <div class="flex items-center w-full max-w-3xl p-8 mx-auto lg:px-12 lg:w-3/5">
            <div class="w-full">
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-3 md:flex md:items-center md:-mx-2">
                        <button id="artisan-btn" class="flex justify-center w-full px-6 py-3 text-blue-400 border border-blue-400 rounded-lg md:w-auto md:mx-2 focus:outline-none focus:bg-blue-500 focus:text-white">
                        ...
                        <button id="client-btn" class="flex justify-center w-full px-6 py-3 mt-4 text-blue-400 border border-blue-400 rounded-lg md:mt-0 md:w-auto md:mx-2 dark:border-blue-400 dark:text-blue-400 focus:bg-blue-500 focus:text-white focus:outline-none">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div id="forms-container" class="flex overflow-hidden transition-transform transform ease-in-out duration-500">
                <div id="artisanForm" class="w-full">
                <form action="" method="POST" class="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2 ">
                    @csrf
                    <div>
                    ...
                    <button type="submit"
                        class="flex items-center justify-between w-full px-6 py-3 text-sm tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-lg hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                        <span>Sign Up </span>
                ...
                <div id="clientForm" class="hidden w-full">
                    <form action="" method="POST" class="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2 ">
                        @csrf
                        <div>
                            <label class="block mb-2 text-sm text-gray-700 ">First Name</label>
                        ...
                        <div>
                            <label class="block mb-2 text-sm text-gray-800">Email Adresse</label>
                            <input name="email" type="text" placeholder="example00@gmail.com" class="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-300 dark:bg-gray-100 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                        </div>
                        ...
                        <button type="submit" class="flex items-center justify-between w-full px-6 py-3 text-sm tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-lg hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                            <span>Sign Up </span>
