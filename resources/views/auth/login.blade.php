...
<div class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-100 lg:max-w-4xl mt-[70px]">
    ...
    <form action="{{ route("login.store") }}" method="POST" class="w-full px-6 py-8 md:px-8 lg:w-1/2">
        ...
        <a href="#" class="flex items-center justify-center mt-4 text-gray-800 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 hover:bg-blue-500 hover:text-white dark:hover:bg-blue-600">
            <div class="px-4 py-2">
